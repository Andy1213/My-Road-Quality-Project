...
# screen positioins - calcualte a 1 pixel high bafr and offset to get width
xLabel = 1
xData = 28
LowerLeft = 0
LowerRight = 128
...
for iReadings in range(50):
    with canvas(device) as draw:
        ...
        draw.rectangle((LowerLeft, 60, LowerRight, 54), fill="white")

        # place a marker at 0 g point
        draw.text((64,32), "*", fill="black")
