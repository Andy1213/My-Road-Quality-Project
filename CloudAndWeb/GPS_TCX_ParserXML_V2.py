...
# 2017 10 16 AJL Output GeoJSON example file
...
# the dataset uses a defult namespace that must prepend searches
...
for lons in myXML.iter(defaultnamespace+'LongitudeDegrees'):
    ...
    #write to GeoJSON file - longitude, latitude
    my_point = Point((float(data_2), float(data_1)))
    my_datum.append(Feature(geometry=my_point, properties={"mag": 5.0}))
